...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($titre && $id_etudiant) {
        $stmt = $conn->prepare("INSERT INTO taches (titre, description, id_etudiant, id_utilisateur, statut, date_creation) VALUES (?, ?, ?, ?, 'en attente', NOW())");
...
<?php if ($success): ?>
<div class="alert alert-success">Tâche ajoutée avec succès.</div>
<?php elseif ($error): ?>
